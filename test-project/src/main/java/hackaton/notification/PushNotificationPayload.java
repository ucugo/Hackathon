...
import hackaton.notification.exceptions.PayloadAlertAlreadyExistsException;
...
public class PushNotificationPayload extends Payload {
   ...
   * @return a ready-to-send payload
   * @throws org.json.JSONException if any exception occurs parsing the JSON string
   */
   ...
   * @throws org.json.JSONException thrown if a exception occurs while parsing the JSON string
   */
   ...
   * @throws org.json.JSONException if a simple alert has already been added to this payload
   */
   ...
   * @throws org.json.JSONException if the custom alert cannot be added because a simple alert already exists
   */
