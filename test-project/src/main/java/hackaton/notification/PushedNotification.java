...
public class PushedNotification {
  ...
  protected PushedNotification(hackaton.devices.Device device, Payload payload) {
    this.device = device;
    this.payload = payload;
  }

  protected PushedNotification(hackaton.devices.Device device, Payload payload, int identifier) {
    this.device = device;
    this.payload = payload;
    this.identifier = identifier;
  }

  public PushedNotification(hackaton.devices.Device device, Payload payload, Exception exception) {
    this.device = device;
    this.payload = payload;
  ...
  protected void setDevice(hackaton.devices.Device device) {
    this.device = device;
  }
  ...
  protected void setResponse(ResponsePacket response) {
    ...
    if (response != null && exception == null)
      exception = new hackaton.notification.exceptions.ErrorResponsePacketReceivedException(response);
  }
  ...
  public static List<PushedNotification> findSuccessfulNotifications(List<PushedNotification> notifications) {
    List<PushedNotification> filteredList = new Vector<>();
