...
import hackaton.devices.Devices;
import hackaton.devices.implementations.basic.BasicDevice;
import hackaton.feedback.AppleFeedbackServer;
import hackaton.notification.AppleNotificationServer;
import hackaton.notification.AppleNotificationServerBasicImpl;
import hackaton.notification.NewsstandNotificationPayload;
import hackaton.notification.Payload;
import hackaton.notification.PayloadPerDevice;
import hackaton.notification.PushNotificationManager;
import hackaton.notification.PushNotificationPayload;
import hackaton.notification.PushedNotification;
import hackaton.notification.transmission.NotificationThread;
import hackaton.notification.transmission.NotificationThreads;
import hackaton.notification.transmission.PushQueue;
 ...
 * @see hackaton.notification.transmission.NotificationThreads
 */
public class Push {
   ...
   * @param keystore a keystore containing your private key and the certificate signed by Apple ({@link java.io.File}, {@link java.io.InputStream}, byte[], {@link java.security.KeyStore} or {@link String} for a file path)
   * @param password the keystore's password.
   * @param production true to use Apple's production servers, false to use the sandbox servers.
   * @param devices a list or an array of tokens or devices: {@link String String[]}, {@link java.util.List}<{@link String}>, {@link hackaton.devices.Device Device[]}, {@link java.util.List}<{@link hackaton.devices.Device}>, {@link String} or {@link hackaton.devices.Device}
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications alert(String message, Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications badge(int badge, Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications sound(String sound, Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications combined(String message, int badge, String sound, Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications contentAvailable(Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications test(Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications payload(Payload payload, Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  private static hackaton.notification.PushedNotifications sendPayload(Payload payload, Object keystore, String password, boolean production, Object devices) throws CommunicationException, KeystoreException {
    hackaton.notification.PushedNotifications notifications = new hackaton.notification.PushedNotifications();
    if (payload == null)
    ...
    try {
      ...
      for (Device device : deviceList) {
        ...
        } catch (hackaton.devices.exceptions.InvalidDeviceTokenFormatException e) {
   ...
   */
  public static hackaton.notification.PushedNotifications payload(Payload payload, Object keystore, String password, boolean production, int numberOfThreads, Object devices) throws Exception {
   ...
   * @param password the keystore's password.
   * @param production true to use Apple's production servers, false to use the sandbox servers.
   * @param payloadDevicePairs a list or an array of PayloadPerDevice: {@link java.util.List}<{@link hackaton.notification.PayloadPerDevice}>, {@link hackaton.notification.PayloadPerDevice PayloadPerDevice[]} or {@link hackaton.notification.PayloadPerDevice}
   * @return a list of pushed notifications, each with details on transmission results and error (if any)
   * @throws hackaton.communication.exceptions.KeystoreException thrown if an error occurs when loading the keystore
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  public static hackaton.notification.PushedNotifications payloads(Object keystore, String password, boolean production, Object payloadDevicePairs) throws CommunicationException, KeystoreException {
   ...
   * @throws Exception thrown if any critical exception occurs
   */
  public static hackaton.notification.PushedNotifications payloads(Object keystore, String password, boolean production, int numberOfThreads, Object payloadDevicePairs) throws Exception {
    if (numberOfThreads <= 0)
      return sendPayloads(keystore, password, production, payloadDevicePairs);
    AppleNotificationServer server = new AppleNotificationServerBasicImpl(keystore, password, production);
   ...
   * @throws hackaton.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
  private static hackaton.notification.PushedNotifications sendPayloads(Object keystore, String password, boolean production, Object payloadDevicePairs) throws CommunicationException, KeystoreException {
    hackaton.notification.PushedNotifications notifications = new hackaton.notification.PushedNotifications();
  ...
  public static List<Device> feedback(Object keystore, String password, boolean production) throws CommunicationException, KeystoreException {
    ...
    hackaton.feedback.FeedbackServiceManager feedbackManager = new hackaton.feedback.FeedbackServiceManager();
    AppleFeedbackServer server = new hackaton.feedback.AppleFeedbackServerBasicImpl(keystore, password, production);
