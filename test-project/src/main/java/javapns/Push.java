 ...
 * @see javapns.notification.transmission.NotificationThreads
 */
public class Push {
   ...
   * @param devices a list or an array of tokens or devices: {@link String String[]}, {@link java.util.List}<{@link String}>, {@link javapns.devices.Device Device[]}, {@link java.util.List}<{@link javapns.devices.Device}>, {@link String} or {@link javapns.devices.Device}
   ...
   * @throws javapns.communication.exceptions.CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
   */
